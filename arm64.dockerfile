...
##docker run --privileged -it -e IMG_NUM="125" -e FPS="25" -e  PUSHSTREAM_URL="rtmp://192.168.20.150:30200/live/stream" \
## -e OBJECTDETECTIONURL="http://192.168.20.150:30001/v1/face/detection" -e EDGE_DEVNAME="edge1-cam1"  david945/aiapp-arm:v9
